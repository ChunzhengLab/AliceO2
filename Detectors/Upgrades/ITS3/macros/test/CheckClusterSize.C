                      ...
                      std::string dictFileName = "", bool batch = true)
{
  ...
  for (int i = 0; i < 4; ++i) {
    ...
    hPrimaryPt.emplace_back(Form("primary_Pt%d", i), Form("L%d Primary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hPrimaryPhi.emplace_back(Form("primary_Phi%d", i), Form("L%d Primary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
    hSecondary.emplace_back(Form("seconday_L%d", i), Form("L%d Secondary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hSecondaryEta.emplace_back(Form("seconday_EtaL%d", i), Form("L%d Secondary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hSecondaryPt.emplace_back(Form("seconday_Pt%d", i), Form("L%d Secondary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hSecondaryPhi.emplace_back(Form("seconday_Phi%d", i), Form("L%d Secondary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);

    hProtonPrimary.emplace_back(Form("proton_primary_L%d", i), Form("Proton - L%d Primary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hProtonPrimaryEta.emplace_back(Form("proton_primary_EtaL%d", i), Form("Proton - L%d Primary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hProtonPrimaryPt.emplace_back(Form("proton_primary_Pt%d", i), Form("Proton - L%d Primary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hProtonPrimaryPhi.emplace_back(Form("proton_primary_Phi%d", i), Form("Proton - L%d Primary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
    hProtonSecondary.emplace_back(Form("proton_seconday_L%d", i), Form("Proton - L%d Secondary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hProtonSecondaryEta.emplace_back(Form("proton_seconday_EtaL%d", i), Form("Proton - L%d Secondary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hProtonSecondaryPt.emplace_back(Form("proton_seconday_Pt%d", i), Form("Proton - L%d Secondary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hProtonSecondaryPhi.emplace_back(Form("proton_seconday_Phi%d", i), Form("Proton - L%d Secondary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);

    hPionPrimary.emplace_back(Form("pion_primary_L%d", i), Form("Pion- L%d Primary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hPionPrimaryEta.emplace_back(Form("pion_primary_EtaL%d", i), Form("Pion- L%d Primary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hPionPrimaryPt.emplace_back(Form("pion_primary_Pt%d", i), Form("Pion- L%d Primary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hPionPrimaryPhi.emplace_back(Form("pion_primary_Phi%d", i), Form("Pion- L%d Primary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
    hPionSecondary.emplace_back(Form("pion_seconday_L%d", i), Form("Pion- L%d Secondary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hPionSecondaryEta.emplace_back(Form("pion_seconday_EtaL%d", i), Form("Pion- L%d Secondary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hPionSecondaryPt.emplace_back(Form("pion_seconday_Pt%d", i), Form("Pion- L%d Secondary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hPionSecondaryPhi.emplace_back(Form("pion_seconday_Phi%d", i), Form("Pion- L%d Secondary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);

    hKaonPrimary.emplace_back(Form("kaon_primary_L%d", i), Form("Kaon- L%d Primary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hKaonPrimaryEta.emplace_back(Form("kaon_primary_EtaL%d", i), Form("Kaon- L%d Primary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hKaonPrimaryPt.emplace_back(Form("kaon_primary_Pt%d", i), Form("Kaon- L%d Primary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hKaonPrimaryPhi.emplace_back(Form("kaon_primary_Phi%d", i), Form("Kaon- L%d Primary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
    hKaonSecondary.emplace_back(Form("kaon_seconday_L%d", i), Form("Kaon- L%d Secondary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hKaonSecondaryEta.emplace_back(Form("kaon_seconday_EtaL%d", i), Form("Kaon- L%d Secondary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hKaonSecondaryPt.emplace_back(Form("kaon_seconday_Pt%d", i), Form("Kaon- L%d Secondary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hKaonSecondaryPhi.emplace_back(Form("kaon_seconday_Phi%d", i), Form("Kaon- L%d Secondary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);

    hOtherPrimary.emplace_back(Form("other_primary_L%d", i), Form("Other - L%d Primary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hOtherPrimaryEta.emplace_back(Form("other_primary_EtaL%d", i), Form("Other - L%d Primary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hOtherPrimaryPt.emplace_back(Form("other_primary_Pt%d", i), Form("Other - L%d Primary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hOtherPrimaryPhi.emplace_back(Form("other_primary_Phi%d", i), Form("Other - L%d Primary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
    hOtherSecondary.emplace_back(Form("other_seconday_L%d", i), Form("Other - L%d Secondary Cluster Size", i), maxClusterSize, -0.5, maxClusterSize-0.5);
    hOtherSecondaryEta.emplace_back(Form("other_seconday_EtaL%d", i), Form("Other - L%d Secondary Cluster Size vs Eta", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, -3.0, 3.0);
    hOtherSecondaryPt.emplace_back(Form("other_seconday_Pt%d", i), Form("Other - L%d Secondary Cluster Size vs Pt", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0.0, 10.0);
    hOtherSecondaryPhi.emplace_back(Form("other_seconday_Phi%d", i), Form("Other - L%d Secondary Cluster Size vs Phi", i), maxClusterSize, -0.5, maxClusterSize-0.5, 100, 0., 2 * o2::constants::math::PI);
  }
...
>>>>>>> its3/matrix_gen
      ...
      if (pInfo.pdg == kProton) {
        ...
        if (pInfo.isPrimary) {
          hPionPrimary[hist_map(id)].Fill(clusterSize);
          hPionPrimaryEta[hist_map(id)].Fill(clusterSize, pInfo.eta);
          hPionPrimaryPt[hist_map(id)].Fill(clusterSize, pInfo.pt);
          hPionPrimaryPhi[hist_map(id)].Fill(clusterSize, pInfo.phi);
        } else {
